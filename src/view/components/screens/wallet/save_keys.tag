...
<save_keys>
	...
	<div if={address} class="wallet-wrap">
		...
		<div class={export:true, show:true}>
			<label><span style="color:#b53e3e">IMPORTANT!</span> Before use app, Export and save this wallet private key</label>
			<div class="wrap">
				<input onclick={copy} value="{private_key}" disabled="disabled" type="text" placeholder="****************************************************************************************************************************************">
				<button onclick={exportPrivateKey} class="ripple need-export">Export</button>
				<p>
				...
				<p>
					Ok, i'am save my key <a href="#ok" onclick={ok}>Continue</a>
				</p>
			</div>
		</div>
